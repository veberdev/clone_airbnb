...
me = User.create(email: "chris@typefast.co", password: "password", first_name: "Chris", last_name: "Jeon")
me.picture.attach(io: user_pictures[0], filename: "#{me.full_name}.jpg")

veber = User.create(email: "veber@dev.com", password: "102030", first_name: "weslley", last_name: "lucas")
